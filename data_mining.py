...
def convert_wandb_csv_subseasonal():
    input_csv = "/mnt/disk1/tunm/Subseasional_Forecasting/results/Strans/2205/mae.csv"  
    station_csv = "/mnt/disk1/env_data/Gauge_thay_Tan/Final_Data_Region_1.csv"     
    time_csv = "/mnt/disk1/tunm/Subseasional_Forecasting/data6789_reg_1_seed52/train.csv"          
    # output_csv = "/mnt/disk1/env_data/result/subseasonal/reg_1/strans/prediction_groundtruth_strans.csv"  
    output_csv = "/mnt/disk1/tunm/Subseasional_Forecasting/results/Strans/2205/mae-final.csv"     
...
def plot_test_1():
    ...
    csv_file = "/mnt/disk1/tunm/Subseasional_Forecasting/results/Strans/2205/mae-final.csv"
    saved_dir = f"/mnt/disk1/tunm/Subseasional_Forecasting/results/Strans/2205/plot/data2/leadtime{lead_time_value}_dr025-mae"    
