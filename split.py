...
def split_reg(region):
    seed = 52
    folder_dir = f"/mnt/disk1/tunn/Subseasonal_Prediction/data6789_reg_{region}_seed{seed}"
    os.makedirs(folder_dir, exist_ok=True)
...
def split_train_valid_reg(region):
    seed = 52
    folder_dir = f"/mnt/disk1/tunn/Subseasonal_Prediction/data2/data6789_reg_{region}_seed{seed}"
    os.makedirs(folder_dir, exist_ok=True)
